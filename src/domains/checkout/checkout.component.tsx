...
import { Input } from '../../__common/__ui-kit/input/input.component';
import { CartAd } from '../cart/components/cart-ad.component';
import { CartTotal } from '../cart/components/cart-total.component';
import { Textarea } from '../../__common/__ui-kit/textarea/textarea.component';
import { Button } from '../../__common/__ui-kit/button/button.component';
import { useCartStore } from '../cart/cart.store';
import { Select as RadixSelect } from '../../__common/__ui-kit/__radix/Select/Select.component';
import { Select } from '../../__common/__ui-kit/select/select.component';
import { CartItem } from '../cart/components/cart-item.component';
import { countries } from '../../__common/countries';
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} className='checkout'>
        <div className='checkout__form'>
          ...
          <div className='checkout__row'>
            <RadixSelect options={countries} placeholder='country' />
          </div>
